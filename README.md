...
My long-term goal is to become an **AI Engineer** capable of building real-world applications with AI at the core.
...
| `strings.py`       | String operations and manipulation         |
| `lists.py`         | Lists and working with collections         |
| `dictionaries.py`  | Dictionaries and key-value data            |
| `conditions.py`    | Conditional statements and decision making |
...
I'm not just memorizing Python syntax. I'm focusing on understanding **why the code works**, how different concepts connect, and how to use them to solve problems.
